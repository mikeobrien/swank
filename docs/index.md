...
<br/>
<ol>
<li>Set <code>RouteTable.Routes.RouteExistingFiles = true</code>. This will route all existing files and folder. This may have repercussions so you may have to ignore routes where physical files need to be served.</li>
