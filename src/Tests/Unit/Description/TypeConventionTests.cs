...
namespace Tests.Unit.Description
{
    ...
    public class TypeConventionTests
    {
        ...
        {
            return new TypeConvention(_comments, new Swank.Configuration.Configuration()).GetDescription(type);
        }
        ...
        public class SomeTypeWithXmlCommentSummary { }

        [Test]
        public void should_return_xml_comment_summary_description_of_datatype()
        {
            var description = GetDescription<SomeTypeWithXmlCommentSummary>();
            description.Name.ShouldEqual("SomeTypeWithXmlCommentSummary");
            description.Comments.ShouldEqual("summary");
        }

        /// <remarks>remarks</remarks>
        public class SomeTypeWithXmlCommentRemarks { }

        [Test]
        public void should_return_xml_comment_remarks_description_of_datatype()
        {
            var description = GetDescription<SomeTypeWithXmlCommentRemarks>();
            description.Name.ShouldEqual("SomeTypeWithXmlCommentRemarks");
        ...
        public void should_return_null_array_comments_if_not_specified(
            [Values(typeof(WithNoArrayComments), 
                typeof(WithEmptyArrayComments))] Type type)
        {
